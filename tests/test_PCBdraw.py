...
def test__can_drawline(capsys):
    testins = PCBdraw(stackup='default_4layer')
    testins.drawline(x1 = 111.76, y1 = 104.14, x2 = 111.76, y2 = 108.635, line_width = 0.4, net_number=2, layer_index=0)
...
def test__can_drawvia(capsys):
    testins = PCBdraw(stackup='default_4layer')
    testins.drawvia(x = 111.76, y = 107.315, viasize=0.8, drillsize=0.4, Layerstring1 = "F.Cu", Layerstring2 = "B.Cu", netnumber=2)
    result = capsys.readouterr()
